        ...
        <div class="panel-body">
            <form class="form-horizontal" method="post" action="">
                ...
                <div class="form-group">
                    ...
                    <label for="name" class="col-sm-1 control-label">集成号</label>
                    <div class="col-sm-2">
                    ...
                    <div class="col-sm-2">
                        <input  value="{{ $res->resDate }}" class="form-control" readonly>
                    </div>
                </div>
                <div class="form-group">
                    <label for="name" class="col-sm-1 control-label">资源数据（data）</label>
                    <div class="col-sm-11">
