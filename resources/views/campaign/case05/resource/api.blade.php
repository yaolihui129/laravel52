...
@section('content')
    <ul class="nav nav-pills" role="tablist">
        ...
        <li role="presentation"><a href="{{url('camp/resource/'.$integrate.'/'.$version.'/2')}}">缺陷分析 </a></li>
        <li role="presentation"><a href="{{url('camp/resource/'.$integrate.'/'.$version.'/3')}}">业务流程接口 </a></li>
        <li role="presentation"  class="active"><a href="{{url('camp/resource/'.$integrate.'/'.$version.'/1')}}">压力、静态代码</a></li>
