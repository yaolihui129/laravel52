	...
	<body>
		<div class="container">
			<form class="form-signin" method="POST" action="/register">
				...
				<input type="text" name="chrUserName" id="name" class="form-control" placeholder="名字" required autofocus>
				<label for="inputEmail" class="sr-only">邮箱</label>
				<input type="email" name="chrEmail" id="inputEmail" class="form-control" placeholder="邮箱" required autofocus>
